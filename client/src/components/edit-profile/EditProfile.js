...
class CreateProfile extends Component {
  ...
  componentWillReceiveProps(nextProps) {
    ...
    if (nextProps.profile.profile) {
      ...
      // If profile field des not exist, make empt string
            ...
            <div className="col-md-8 m-auto">
              ...
              <form onSubmit={this.onSubmit}>
                <TextFieldGroup
                  ...
                  onChange={this.onChange}
                  error={errors.handle}
                  info="A unique handle for our profile URL. Your ful name, compaan name, and nickname"
                />
                <SelectListGroup
                  placeholder="* Profile Handle"
                  name="handle"
                ...
                <TextFieldGroup
                  ...
                  info="City or city &amp; state suggested (eg. Philadelphia, Pa)"
                />
                <TextFieldGroup
                  placeholder="* Skills"
                  name="skills"
                ...
                <div className="mb-3">
                  ...
                  <span className="text-muted">Optiional</span>
                </div>
                {socialInputs}
                <input
                  type="submit"
